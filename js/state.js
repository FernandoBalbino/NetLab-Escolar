(function () {
  ...
  var challengeIds = [
    ...
    "mac-identities", "mac-conflict", "mac-destination",
  ...
  function defaultProgress() {
    ...
    return {
      unlocked: ["basic-direct", "types-lan-ports", "mac-identities", "star"],
      completed: completed,
  ...
  function mergeProgress(progress) {
    ...
    fresh.unlocked = Array.from(new Set(["basic-direct", "types-lan-ports", "mac-identities", "star"].concat(unlocked)));
    return fresh;
  }
